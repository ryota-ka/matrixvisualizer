...
var App = function () {
  function App(subscriber) {
    _classCallCheck(this, App);

    this.matrix = new _Matrix2.default(1, 0, 0, 1);
  ...
  _createClass(App, [{
    ...
    set: function set(_ref) {
      ...
      Object.assign(this.matrix, { a: a, b: b, c: c, d: d });
      this.fire();
    }
  }]);
...
},{"./Matrix":302}],299:[function(require,module,exports){
'use strict';
...
var CanvasDrawer = function () {
  ...
  _createClass(CanvasDrawer, [{
    key: 'changeShapeType',
    value: function changeShapeType() {
    ...
    key: 'drawShape',
    value: function drawShape(matrix) {
    ...
    key: 'drawEigenVectors',
    value: function drawEigenVectors(matrix) {
      ...
      var l = matrix.eigenvalues.map(function (x) {
        return x.re;
      });
      ...
      matrix.eigenvectors.map(function (_ref) {
    ...
    value: function drawGrid() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var _map = [1, -1].map(function (sig) {
            return width / 2 + 50 * i * sig;
          }),
        ...
        for (var _iterator = (0, _range2.default)(Math.ceil(canvas.width / 100))[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          _loop();
        }
      } catch (err) {
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          var _map3 = [1, -1].map(function (sig) {
            return height / 2 + 50 * i * sig;
          }),
        ...
        for (var _iterator2 = (0, _range2.default)(Math.ceil(canvas.height / 100))[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          _loop2();
        }
      } catch (err) {
...
},{"./range":304}],300:[function(require,module,exports){
"use strict";
...
var Complex = function () {
  function Complex(re, im) {
    ...
    Object.assign(this, { re: re, im: im });
  }

  _createClass(Complex, [{
    key: "equals",
    value: function equals(other) {
      return [other instanceof Complex, Math.abs(this.re - other.re) < Number.EPSILON, Math.abs(this.im - other.im) < Number.EPSILON].every(function (x) {
        return x;
      });
    }
  }, {
...
var Info = function () {
  ...
  _createClass(Info, [{
    ...
    key: 'eigenvalues',
    value: function eigenvalues(matrix) {
      var _matrix$eigenvalues = _slicedToArray(matrix.eigenvalues, 2),
          x = _matrix$eigenvalues[0],
          y = _matrix$eigenvalues[1];
      ...
      switch (true) {
        ...
        default:
          return 'eigenvalues: ' + round(x.re) + ' \xB1 ' + round(x.im) + 'i';
      }
    }
  }, {
    key: 'eigenvectors',
    value: function eigenvectors(matrix) {
      var a = matrix.a,
          b = matrix.b,
          c = matrix.c,
          d = matrix.d;
      ...
      switch (matrix.eigenvectors.length) {
        ...
        case 1:
          {
            var _matrix$eigenvectors = _slicedToArray(matrix.eigenvectors, 1),
                _matrix$eigenvectors$ = _slicedToArray(_matrix$eigenvectors[0], 2),
                s = _matrix$eigenvectors$[0],
                t = _matrix$eigenvectors$[1];
        ...
        case 2:
          {
            var _matrix$eigenvectors2 = _slicedToArray(matrix.eigenvectors, 2),
                _matrix$eigenvectors3 = _slicedToArray(_matrix$eigenvectors2[0], 2),
                _s = _matrix$eigenvectors3[0],
                _t = _matrix$eigenvectors3[1],
                _matrix$eigenvectors4 = _slicedToArray(_matrix$eigenvectors2[1], 2),
                u = _matrix$eigenvectors4[0],
                v = _matrix$eigenvectors4[1];

            return _s === u && _t === v ? 'eigenvector: (' + round(_s) + ', ' + round(_t) + ')' : 'eigenvectors: (' + round(_s) + ', ' + round(_t) + '), (' + round(u) + ', ' + round(v) + ')';
          }
      }
    }
  }, {
    key: 'trace',
    value: function trace(matrix) {
    ...
    value: function render(matrix) {
      ...
      Object.keys(this.elems).forEach(function (key) {
        return _this.elems[key].textContent = _this[key](matrix);
      });
    }
  }]);
...
var Matrix = function () {
  function Matrix(a, b, c, d) {
    ...
    Object.assign(this, { a: a, b: b, c: c, d: d });
  }
  ...
  _createClass(Matrix, [{
    ...
    get: function get() {
      ...
      var discriminant = (Math.pow(trace, 2) - 4 * determinant) / 4;
      var rootD = Math.sqrt(Math.abs(discriminant));

      return [1, -1].map(function (sig) {
        return discriminant >= 0 ? new _Complex2.default(trace / 2 + sig * rootD, 0) : new _Complex2.default(trace / 2, sig * rootD);
      });
    }
  }, {
    key: 'eigenvectors',
    get: function get() {
      ...
      var _eigenvalues$map = this.eigenvalues.map(function (x) {
        return x.re;
      }),
          _eigenvalues$map2 = _slicedToArray(_eigenvalues$map, 2),
          l0 = _eigenvalues$map2[0],
          l1 = _eigenvalues$map2[1];
      ...
      var _map = [s * s + t * t, u * u + v * v].map(Math.sqrt),
          _map2 = _slicedToArray(_map, 2),
          n0 = _map2[0],
          n1 = _map2[1];
...
},{"./Complex":300}],303:[function(require,module,exports){
'use strict';
...
var _CanvasDrawer = require('./CanvasDrawer');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var canvasDrawer = new _CanvasDrawer2.default(canvas);
  var info = new _Info2.default();

  var app = new _App2.default(function (matrix) {
  ...
  var update = function update() {
    var a = Number(fields.a.value) || 0;
    var b = Number(fields.b.value) || 0;
    var c = Number(fields.c.value) || 0;
    var d = Number(fields.d.value) || 0;

    app.state = { a: a, b: b, c: c, d: d };
  };
...
},{"./App":298,"./CanvasDrawer":299,"./Info":301,"babel-polyfill":1}],304:[function(require,module,exports){
"use strict";
